# Pokédex (Modern Web App)

A high-performance, responsive Pokédex built with **React 19**, **Flask**, and **Tailwind CSS**. This project features infinite scrolling, fuzzy searching, real-time capture status persistence, and a premium dashboard aesthetic.
...
```
*Note: This project requires specifically Flask 2.0.2 and Werkzeug < 3.0 to ensure compatibility.*
